package com.example.kotlindemo.widget.drawable
...
class GradientBorderDrawable(private var borderColors: IntArray = DEFAULT_COLORS,
                             ...
                             private var bgAngle: Int = ANGLE_LEFT_RIGHT
) : Drawable() {

    companion object {
        @JvmField val DEFAULT_COLORS = intArrayOf(Color.TRANSPARENT, Color.TRANSPARENT)
        @JvmField val DEFAULT_BORDER_WIDTH = dip2px(5f).toFloat()
        @JvmField val DEFAULT_RADIUS = dip2px(10f).toFloat()
