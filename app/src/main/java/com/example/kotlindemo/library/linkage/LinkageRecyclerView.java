package com.example.kotlindemo.library.linkage;
/*
...
import com.example.kotlindemo.library.linkage.adapter.LinkagePrimaryAdapter;
import com.example.kotlindemo.library.linkage.adapter.LinkageSecondaryAdapter;
import com.example.kotlindemo.library.linkage.bean.BaseGroupedItem;
import com.example.kotlindemo.library.linkage.bean.DefaultGroupedItem;
import com.example.kotlindemo.library.linkage.contract.ILinkagePrimaryAdapterConfig;
import com.example.kotlindemo.library.linkage.contract.ILinkageSecondaryAdapterConfig;
import com.example.kotlindemo.library.linkage.defaults.DefaultLinkagePrimaryAdapterConfig;
import com.example.kotlindemo.library.linkage.defaults.DefaultLinkageSecondaryAdapterConfig;
import com.example.kotlindemo.library.linkage.manager.RecyclerViewScrollHelper;
